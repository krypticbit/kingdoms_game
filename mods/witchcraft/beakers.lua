...
-- Empty beaker
minetest.register_node("witchcraft:beaker_empty", {
...
local function register_beaker(name, description, texture)
   ...
   local bname = "witchcraft:beaker_" .. name
   ...
   minetest.register_node(bname, {
      ...
      on_drop = function(itemstack, dropper, pos)
         local effect = witchcraft.effects[itemstack:get_name()]
         if effect then
            effect(dropper, pos)
         end
         itemstack:take_item()
...
witchcraft.register_beaker = register_beaker
