local function register_herb(name, description, texture, from)
   local hname = "witchcraft:herb_" .. name
   ...
   for f, chance in pairs(from) do
      ...
      if witchcraft.herbs[f] == nil then
         witchcraft.herbs[f] = {}
      end
      -- Add herb to table
      witchcraft.herbs[f][hname] = chance
   end
end
...
register_herb("iceweed", "Iceweed Herb", "herb_iceweed.png", {["default:grass_1"] = 200})
